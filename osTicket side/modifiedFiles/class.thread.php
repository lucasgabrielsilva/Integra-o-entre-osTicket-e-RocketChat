...
implements Searchable {
    ...
    function getNumAtta(){
        $a = Attachment::objects()->filter(array('thread_entry__thread' => $this));
	return $a;
    }
...
implements TemplateVariable {
    ...
    */
    ...
    function getAttachmentUrlsForChat() {
        $files = array();
        foreach ($this->attachments as $att){
            $data = array('name' => $att->getFilename(),'url' => $att->file->getDownloadUrlForChat());
            if($data){
