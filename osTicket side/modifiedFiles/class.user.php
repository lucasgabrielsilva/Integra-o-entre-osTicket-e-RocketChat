...
implements TemplateVariable, Searchable {
    ...
    function getUserNameForChat(){
        ...
        $sql = "select dbuseraccount.username 
            from ost_user as dbuser, ost_user_account as dbuseraccount 
            where dbuser.id = ".$id." and dbuseraccount.user_id = dbuser.id;";
        $res = db_query($sql);
        $res = db_result($res);
        return $res;
    }
